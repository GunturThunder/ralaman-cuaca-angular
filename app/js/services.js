...
angular.module('openWeatherApp.services', ['ngResource'])
  ...
  //
  .value('exampleLocations',['Jakarta','Bandung','Bogor','Maluku','Pekanbaru','Pontianak','Jambi','Malang'])
  //
  // Storm "Xaver" special locations
  //
  .value('stormLocations',['Sylt','St. Peter-Ording','Husum','Bremerhaven','Jakarta','Kiel','Lübeck'])
